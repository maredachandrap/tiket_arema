  ...
  <form>
    ...
    <div class="row">
      ...
      <div class="col-half">
        <h4>TRIBUN</h4>
        <div class="input-group">
          <input type="radio" name="gender" value="VIP" id="gender-VIP"/>
          <label for="gender-VIP">VIP</label>
          <input type="radio" name="gender" value="VVIP" id="gender-VVIP"/>
          <label for="gender-VVIP">VVIP</label>
          <input type="radio" name="gender" value="EKONOMI" id="gender-EKONOMI"/>
          <label for="gender-EKONOMI">EKONOMI</label>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="input-group input-group-icon">
        <input type="text" placeholder="PULSA"/>
